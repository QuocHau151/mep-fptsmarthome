      ...
      <div className="text-center flex flex-col  ">
        <div className="container border-b-[1px] pb-[100px]">
          ...
          <div className="flex flex-col items-start gap-4 text-left text-[18px]">
            ...
            <h5 className="font-semibold text-[22px]">Thiết kế sang trọng</h5>
            <p>
            ...
            <h5 className="font-semibold text-[22px]">Công nghệ hiện đại</h5>
            <p>
            ...
            <h5 className="font-semibold text-[22px]">Dễ dàng lắp đặt</h5>
            <p>
