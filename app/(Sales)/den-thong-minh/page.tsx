...
export default function Page() {
  return (
    <div>
      <div>
        <div className="bg-[url('/assets/images/product/thumnail/1668574949-den.jpg')] w-full h-[500px] bg-cover bg-no-repeat bg-center"></div>
      </div>
      <div className="container">
        ...
        <div>
          <div className="text-center flex flex-col py-[30px] mb-10">
            <h4 className="text-h5 text-gray-400 font-semibold">
          ...
          <div className="flex flex-col items-start gap-4 pb-[100px]">
            <h1 className="text-[26px] font-semibold">Đèn thông minh là gì?</h1>
            <p>
