...
export default function CanHo2PN() {
  ...
  const [selected, setSelected] = useState<string>("C3PN");
  ...
  return (
    <>
      <div className="bg-gray-100">
        <div className=" container pt-[170px] pb-[50px] max-lg:pt-[120px] max-md:pt-[100px] max-md:mx-0">
      ...
      <div className="container flex flex-col  pt-[50px] pb-[100px] max-md:pb-[30px] max-md:mr-4">
        <Tabs
